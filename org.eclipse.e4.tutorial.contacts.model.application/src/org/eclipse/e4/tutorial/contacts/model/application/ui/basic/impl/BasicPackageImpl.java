...
public class BasicPackageImpl extends EPackageImpl implements BasicPackage
{
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link BasicPackage#eINSTANCE} when that field is accessed.
	...
	public void initializePackageContents()
	{
		...
		initEClass(tutorialPartStackEClass, TutorialPartStack.class, "TutorialPartStack",
			!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTutorialPartStack_MyRenderer(), ecorePackage.getEString(), "myRenderer",
			null, 0, 1, TutorialPartStack.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
