...
public class BasicAdapterFactory extends AdapterFactoryImpl
{
	 ...
	 * <em>Tutorial Part Stack</em>}'. <!-- begin-user-doc --> This default implementation returns
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.MApplicationElement <em>Element</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.ui.MUIElement <em>UI Element</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 *
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.ui.MGenericStack <em>Generic Stack</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 *
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.ui.basic.MPartSashContainerElement <em>Part Sash
	 * Container Element</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.ui.basic.MWindowElement <em>Window
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.e4.ui.model.application.ui.basic.MPartStack <em>Part Stack</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 *
