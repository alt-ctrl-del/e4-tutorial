...
public class BasicSwitch<T1> extends Switch<T1>
{
	...
	protected T1 doSwitch(int classifierID, EObject theEObject)
	{
		...
		case BasicPackage.TUTORIAL_PART_STACK:
		{
			...
			if (result == null)
				result = casePartStack(tutorialPartStack);
			if (result == null)
				result = caseGenericStack(tutorialPartStack);
			if (result == null)
				result = casePartSashContainerElement(tutorialPartStack);
			if (result == null)
				result = caseWindowElement(tutorialPartStack);
			if (result == null)
				result = caseElementContainer(tutorialPartStack);
			if (result == null)
				result = caseUIElement(tutorialPartStack);
			if (result == null)
				result = caseApplicationElement(tutorialPartStack);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tutorial Part
	 * Stack</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null
	 * result will terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tutorial Part
	 *         Stack</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Part Sash Container
	 * Element</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null
	 * result will terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Part Sash Container
	 *         Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
