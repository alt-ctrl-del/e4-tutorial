...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Tutorial Part
 * Stack</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.e4.tutorial.contacts.model.application.ui.basic.impl.TutorialPartStackImpl#getMyRenderer
...
public class TutorialPartStackImpl extends PartStackImpl implements TutorialPartStack
{
	...
	public void setMyRenderer(String newMyRenderer)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				BasicPackage.TUTORIAL_PART_STACK__MY_RENDERER, oldMyRenderer, myRenderer));
	}
	...
	public boolean eIsSet(int featureID)
	{
		...
		{
		case BasicPackage.TUTORIAL_PART_STACK__MY_RENDERER:
			return MY_RENDERER_EDEFAULT == null ? myRenderer != null
				: !MY_RENDERER_EDEFAULT.equals(myRenderer);
		}
