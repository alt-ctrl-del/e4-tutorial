...
public interface BasicFactory extends EFactory
{
	 ...
	 * @generated
	 */
	BasicFactory eINSTANCE = org.eclipse.e4.tutorial.contacts.model.application.ui.basic.impl.BasicFactoryImpl
		.init();

	/**
	 * Returns a new object of class '<em>Tutorial Part Stack</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
